...
<head>
    ...
    <link rel="stylesheet" href="stylePendaftaran_al.css"> 
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            <!-- Gambar logo TNI AD -->
            <img src="Insignia_of_the_Indonesian_Navy.svg.png" alt="Logo TNI AL" class="logo-form">
            <!-- Judul formulir, diberi kelas baru agar spesifik -->
            <h1 class="section-title-form">Formulir Pendaftaran TNI AL</h1>
        </div>
        
        <form action="proses_pendaftaran_al.php" method="post" enctype="multipart/form-data" class="registration-form">
