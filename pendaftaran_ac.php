...
<head>
    ...
    <link rel="stylesheet" href="stylePendaftaran_ac.css"> 
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            ...
            <h1 class="section-title-form">Formulir Pendaftaran TNI AC</h1>
        </div>
        
        <form action="proses_pendaftaran_ac.php" method="post" enctype="multipart/form-data" class="registration-form">
