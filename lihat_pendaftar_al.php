...
<head>
    ...
    <title>Lihat Pendaftar TNI AL</title>
    <!-- CSS khusus untuk halaman ini (tabel, canvas hijau, logo di header) -->
    <link rel="stylesheet" href="style_lihat_pendaftar_al.css">
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Insignia_of_the_Indonesian_Navy.svg/330px-Insignia_of_the_Indonesian_Navy.svg.png" alt="Logo TNI AL" class="logo-form">
            <h1 class="section-title-form">Data Pendaftar TNI AL</h1>
        </div>
        ...
        <div class="table-container">
            ...
            <div class="table-controls-container">
                ...
                <a href="pendaftaran_al.php" class="add-new-button">
                ...
                <form action="" method="GET" class="search-form">
                    ...
                    <?php if (isset($_GET['keyword']) && $_GET['keyword'] != ''): ?>
                        <a href="lihat_pendaftar_al.php" class="reset-search-button">Reset</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    // Query dasar sesuai yang Anda berikan (untuk pendaftaran_al)
                    $query_show_data = "SELECT 
                                            ...
                                            nama_sekolah, 
                                            pas_foto
                                         FROM pendaftaran_al"; // Pastikan tabel ini benar
                        ...
                        <tr>
                            ...
                            <td class="pas-foto-cell">
                                <?php if (!empty($data['pas_foto'])): ?>
                                    <img src="img_pendaftaran_al/<?php echo $data["pas_foto"]; ?>" alt="Pas Foto" class="pas-foto-thumbnail">
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td class="action-buttons-cell">
                                <!-- Link Edit Data Pendaftar AL -->
                                <a href="edit_pendaftar_al.php?nik=<?php echo $data['nik']; ?>" class="action-button edit-button" title="Edit Data">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <!-- Link Hapus Data Pendaftar AL -->
                                <a href="proses_hapus_pendaftar_al.php?nik=<?php echo $data['nik']; ?>" class="action-button delete-button" title="Hapus Data" onclick="return confirm('Apakah Anda yakin ingin menghapus data <?php echo $data['nama_lengkap']; ?>?');">
