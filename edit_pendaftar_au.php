...
<head>
    ...
    <link rel="stylesheet" href="style_edit_pendaftar_au.css">
    ...
    <main class="main-content">
        ...
        <div class="form-container">
            <?php
                ...
                $query_ambil_data_pendaftar_tertentu = "SELECT * FROM pendaftaran_aU WHERE nik='$nik'";
            ...
            ?>
            <form action="proses_update_pendaftar_au.php" method="post" enctype="multipart/form-data" class="edit-form">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($data['pas_foto'])): ?>
                        <p>Foto saat ini:</p>
                        <img src="img_pendaftaran_au/<?= $data['pas_foto']; ?>" alt="Pas Foto Saat Ini" class="current-pas-foto-thumbnail">
                ...
                <a href="lihat_pendaftar_au.php" class="back-button">Kembali ke Daftar</a>
            </form>
            <?php 
