...
<head>
    ...
    <link rel="stylesheet" href="stylePendaftaran_alu.css"> 
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            <!-- Gambar logo TNI AD -->
            <img src="ChatGPT Image 16 Jun 2025, 09.43.57.png" alt="Logo TNI AL" class="logo-form">
            <!-- Judul formulir, diberi kelas baru agar spesifik -->
            <h1 class="section-title-form">Formulir Pendaftaran TNI ALU</h1>
        </div>
        
        <form action="proses_pendaftaran_alu.php" method="post" enctype="multipart/form-data" class="registration-form">
