...
<head>
    ...
    <link rel="stylesheet" href="stylePendaftaran_ad.css"> 
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            <!-- Gambar logo TNI AD -->
            <img src="Insignia_of_the_Indonesian_Army.svg.png" alt="Logo TNI AD" class="logo-form">
            <!-- Judul formulir, diberi kelas baru agar spesifik -->
            <h1 class="section-title-form">Formulir Pendaftaran TNI AD</h1>
        </div>
        
        <form action="proses_pendaftaran_ad.php" method="post" enctype="multipart/form-data" class="registration-form">
