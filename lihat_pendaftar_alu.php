...
<head>
    ...
    <title>Lihat Pendaftar TNI ALU</title>
    <!-- CSS khusus untuk halaman ini (tabel, canvas biru gelap, logo di header) -->
    <link rel="stylesheet" href="style_lihat_pendaftar_alu.css">
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="header-content-wrapper">
            <!-- Menggunakan placeholder image untuk logo TNI ALU -->
            <img src="ChatGPT Image 16 Jun 2025, 09.43.57.png" alt="Logo TNI ALU" class="logo-form">
            <h1 class="section-title-form">Data Pendaftar TNI ALU</h1>
        </div>
        ...
        <div class="table-container">
            ...
            <div class="table-controls-container">
                ...
                <a href="pendaftaran_alu.php" class="add-new-button">
                ...
                <form action="" method="GET" class="search-form">
                    ...
                    <?php if (isset($_GET['keyword']) && $_GET['keyword'] != ''): ?>
                        <a href="lihat_pendaftar_alu.php" class="reset-search-button">Reset</a>
                    <?php endif; ?>
                </form>
            </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    // Query dasar sesuai yang Anda berikan (untuk pendaftaran_alu)
                    $query_show_data = "SELECT 
                                            ...
                                            nama_sekolah, 
                                            pas_foto
                                         FROM pendaftaran_alu"; // Pastikan tabel ini benar
                        ...
                        <tr>
                            ...
                            <td class="pas-foto-cell">
                                <?php if (!empty($data['pas_foto'])): ?>
                                    <img src="img_pendaftaran_alu/<?php echo $data["pas_foto"]; ?>" alt="Pas Foto" class="pas-foto-thumbnail">
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td class="action-buttons-cell">
                                <!-- Link Edit Data Pendaftar ALU -->
                                <a href="edit_pendaftar_alu.php?nik=<?php echo $data['nik']; ?>" class="action-button edit-button" title="Edit Data">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <!-- Link Hapus Data Pendaftar ALU -->
                                <a href="proses_hapus_pendaftar_alu.php?nik=<?php echo $data['nik']; ?>" class="action-button delete-button" title="Hapus Data" onclick="return confirm('Apakah Anda yakin ingin menghapus data <?php echo $data['nama_lengkap']; ?>?');">
