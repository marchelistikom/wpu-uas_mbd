...
if (isset($_FILES['pas_foto']) && $_FILES['pas_foto']['error'] === UPLOAD_ERR_OK) {
    ...
    $upload_dir = 'img_pendaftaran_ad/'; // Pastikan folder ini ada
    ...
    if (move_uploaded_file($file_tmp, $upload_path)) {
        ...
        echo '<script>
                ...
                window.location.href = "lihat_pendaftar_ad.php";
              </script>';
...
$query_update_data = "UPDATE pendaftaran_ad SET 
...
if (mysqli_query($koneksi, $query_update_data)) {
    ...
    echo '<script>
            ...
            window.location.href = "lihat_pendaftar_ad.php"; // Atau bisa juga ke halaman error khusus
          </script>';
    exit();
}
