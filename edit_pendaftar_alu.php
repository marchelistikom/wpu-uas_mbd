...
<head>
    ...
    <link rel="stylesheet" href="style_edit_pendaftar_alu.css">
...
<body>
    ...
    <main class="main-content">
        <div class="header-content-wrapper">
            ...
            <h1 class="section-title-form">FORMULIR EDIT DATA PENDAFTAR TNI ALU</h1>
        </div>
        ...
        <div class="form-container">
            <?php
                ...
                $query_ambil_data_pendaftar_tertentu = "SELECT * FROM pendaftaran_alu WHERE nik='$nik'";
            ...
            ?>
            <form action="proses_update_pendaftar_alu.php" method="post" enctype="multipart/form-data" class="edit-form">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($data['pas_foto'])): ?>
                        <p>Foto saat ini:</p>
                        <img src="img_pendaftaran_alu/<?= $data['pas_foto']; ?>" alt="Pas Foto Saat Ini" class="current-pas-foto-thumbnail">
                ...
                <a href="lihat_pendaftar_alu.php" class="back-button">Kembali ke Daftar</a>
            </form>
            <?php 
